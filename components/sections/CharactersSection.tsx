...
const CharactersSection: React.FC = () => {
  ...
  return (
    <SectionWrapper
      ...
      className="overflow-hidden" // Keeping overflow-hidden for marquee
    >
      ...
      {/* Gradient Fades - Adjusted for Cream BG */}
      <div className="absolute left-0 w-8 md:w-20 bg-gradient-to-r from-[#FFF6E6] to-transparent pointer-events-none h-full top-0 z-10"></div>
      <div className="absolute right-0 w-8 md:w-20 bg-gradient-to-l from-[#FFF6E6] to-transparent pointer-events-none h-full top-0 z-10"></div>
