...
const MascotDesignView: React.FC<MascotDesignViewProps> = ({ onNavigate }) => {
    ...
    return (
        <div className="min-h-screen bg-white font-body text-gray-900 overflow-x-hidden relative">
            {/* Abstract Background Elements */}
            <div className="absolute top-0 right-0 w-[50vh] h-[50vh] bg-brand-yellow/30 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/2 pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 w-[50vh] h-[50vh] bg-brand-pink/20 rounded-full blur-[100px] translate-y-1/2 -translate-x-1/2 pointer-events-none"></div>
            ...
            <div className="max-w-7xl mx-auto px-6 py-12 md:py-20 min-h-[90vh] flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
