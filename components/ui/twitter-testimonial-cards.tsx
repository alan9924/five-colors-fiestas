...
function TestimonialCard({
    ...
    return (
        <a
            ...
            className={cn(
                "relative flex h-auto w-full select-none flex-col rounded-3xl",
                "border border-zinc-200/80 bg-white",
                "px-4 sm:px-5 py-4 sm:py-5",
                "shadow-sm transition-all duration-300",
                "hover:-translate-y-1 hover:shadow-md hover:border-zinc-300",
                "active:translate-y-0",
                isActive && "ring-2 ring-zinc-900/10",
                className
            )}
        >
            {/* Header */}
...
export default function Testimonials({ cards }: TestimonialsProps) {
    ...
    const getCardClassName = (_index: number, base: string) => base;
    ...
    const defaultCards: TestimonialCardProps[] = [
        {
            className:
                "[grid-area:stack] opacity-30 translate-x-2 sm:translate-x-4 -translate-y-2 sm:-translate-y-3 rotate-[-2deg]",
            avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Escuelas",
            username: "Personajes para Escuelas",
            handle: "@FiveColorsLab",
            content:
                "Mascotas que representan los valores de tu institución educativa. Perfectas para motivar a los estudiantes y crear sentido de pertenencia. Features: Diseño amigable • Colores institucionales • Durabilidad garantizada",
            date: "2024",
            verified: true,
            likes: 120,
            retweets: 45,
        ...
        {
            className:
                "[grid-area:stack] opacity-55 translate-x-4 sm:translate-x-8 -translate-y-1 sm:-translate-y-2 rotate-[-1deg]",
            avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Deportivos",
            username: "Deportivos",
            handle: "@FiveColorsLab",
            content:
                "Mascotas para equipos deportivos que inspiran pasión y unidad. Diseñadas para resistir el entusiasmo de los aficionados. Features: Diseño dinámico • Resistente a uso rudo • Personalización completa",
            date: "2024",
            verified: true,
            likes: 135,
            retweets: 50,
        ...
        {
            className:
                "[grid-area:stack] opacity-100 translate-x-0 translate-y-0 rotate-[0deg]",
            avatar: "https://api.dicebear.com/7.x/avataaars/svg?seed=Fanaticos",
            username: "Fanáticos",
            handle: "@FiveColorsLab",
            content:
                "Personajes únicos para grupos de fans y comunidades. Dale vida a tu pasión con una botarga que te represente. Features: Diseño personalizado • Detalles únicos • Expresión de identidad",
            date: "2024",
            verified: true,
            likes: 150,
            retweets: 55,
