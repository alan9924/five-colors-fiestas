            ...
            >
                ...
                >
                    {cards.map((imgUrl, i) => (
                        <motion.div
                            key={`key-${imgUrl}-${i}`}
                            className="absolute flex h-full origin-center items-center justify-center rounded-xl bg-white overflow-hidden"
                            style={{
                                width: `${faceWidth}px`,
                        ...
                        >
                            <motion.img
                                ...
                                alt={`Show ${i + 1}`}
                                layoutId={`img-${imgUrl}`}
                                className="pointer-events-none w-full h-full rounded-xl object-cover shadow-lg border-2 border-gray-900"
