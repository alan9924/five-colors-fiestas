...
const Footer: React.FC = () => {
    return (
        <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-16 border-t-4 border-brand-yellow">
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex justify-center items-center gap-3 py-6">
                    <a
                        href="mailto:fivecolorshows@gmail.com"
                        className="flex items-center gap-3 px-6 py-3 bg-gray-800/50 rounded-full border border-gray-700 hover:border-brand-yellow hover:bg-gray-800 transition-all duration-300 group"
                    >
                        <svg
                            className="w-5 h-5 text-brand-yellow group-hover:scale-110 transition-transform"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                        ...
                        <span className="text-white font-semibold group-hover:text-brand-yellow transition-colors">
                            fivecolorshows@gmail.com
                        </span>
                    </a>
                </div>
